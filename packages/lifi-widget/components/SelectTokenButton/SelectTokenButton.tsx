    ...
    >
      ...
      >
          ...
          <SelectTokenCardHeader
            avatar={
              isSelected ? (
                <TokenAvatar
                  token={token}
                  chain={chain}
                  mainAvatarStyle={{ width: "44px", height: "44px" }}
                  smallAvatarStyle={{
            ...
            title={
              isSelected ? (
                ...
                <span style={{ fontWeight: "700", color: "#8D9C9E" }}>
                  {defaultPlaceholder}
                </span>
              )
            }
        ...
        >
          ...
          >
            <path
              d="M7.71191 6.15453L1.70191 0.144531L0.286912 1.55853L4.88691 6.15853L0.286912 10.7585L1.70191 12.1655L7.71191 6.15453Z"
              fill="#F8F9FD"
            />
          </svg>
        </div>
