    ...
    <>
      <HeaderAppBar
        ...
        style={{
          ...
          paddingLeft: pathname === "/" ? "0" : "24px",
        }}
        className="preventHover"
      >
                ...
                {account.isActive && !hiddenUI?.includes(HiddenUI.History) ? (
                  ...
                  >
                    <IconButton
                      ...
                      onClick={() =>
                        search.includes("transactionHistory")
                          ? navigate(`${pathname}`)
                    ...
                    >
                      ...
                      >
                        <path
                          d="M13.2353 7.0386C13.2353 6.84449 13.0765 6.68566 12.8824 6.68566H7.23529C7.04118 6.68566 6.88235 6.84449 6.88235 7.0386C6.88235 7.23272 7.04118 7.39154 7.23529 7.39154H12.8824C13.0765 7.39154 13.2353 7.23272 13.2353 7.0386ZM12.8824 9.15625H7.23529C7.04118 9.15625 6.88235 8.99743 6.88235 8.80331C6.88235 8.60919 7.04118 8.45037 7.23529 8.45037H12.8824C13.0765 8.45037 13.2353 8.60919 13.2353 8.80331C13.2353 8.99743 13.0765 9.15625 12.8824 9.15625ZM12.8824 10.921H7.23529C7.04118 10.921 6.88235 10.7621 6.88235 10.568C6.88235 10.3739 7.04118 10.2151 7.23529 10.2151H12.8824C13.0765 10.2151 13.2353 10.3739 13.2353 10.568C13.2353 10.7621 13.0765 10.921 12.8824 10.921ZM12.8824 5.62684H7.23529C7.04118 5.62684 6.88235 5.46801 6.88235 5.2739C6.88235 5.07978 7.04118 4.92096 7.23529 4.92096H12.8824C13.0765 4.92096 13.2353 5.07978 13.2353 5.2739C13.2353 5.46801 13.0765 5.62684 12.8824 5.62684ZM3.35294 11.9798V13.3915C3.35294 14.3657 4.14353 15.1562 5.11765 15.1562H13.2353C14.0153 15.1562 14.6471 14.5245 14.6471 13.7445V3.50919C14.6471 3.31507 14.4882 3.15625 14.2941 3.15625H5.82353C5.62941 3.15625 5.47059 3.31507 5.47059 3.50919V11.8351L4.76471 12.541L3.95647 11.7292C3.85412 11.6304 3.70235 11.5986 3.57176 11.6551C3.43765 11.708 3.35294 11.8386 3.35294 11.9798ZM6.17647 3.86213H13.9412V13.7445C13.9412 14.1327 13.6235 14.4504 13.2353 14.4504C12.8471 14.4504 12.5294 14.1327 12.5294 13.7445V11.9798C12.5294 11.8386 12.4447 11.708 12.3106 11.6551C12.18 11.5986 12.0282 11.6304 11.9259 11.7292L11.1176 12.541L10.3094 11.7292C10.1718 11.5915 9.94588 11.5915 9.80823 11.7292L9 12.541L8.19176 11.7292C8.05412 11.5915 7.82824 11.5915 7.69059 11.7292L6.88235 12.541L6.17647 11.8351V3.86213Z"
                          fill="white"
                        />
                      </svg>
                    </IconButton>
