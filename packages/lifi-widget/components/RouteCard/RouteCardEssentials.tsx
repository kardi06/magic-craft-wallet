          ...
          <IconTypography>
            ...
            >
              <g clipPath="url(#clip0_1562_28928)">
                <path
                  d="M12.392 5.983C11.456 5.047 10.232 4.575 9 4.575V9.375L5.608 12.767C7.48 14.639 10.52 14.639 12.4 12.767C14.272 10.895 14.272 7.855 12.392 5.983ZM9 1.375C4.584 1.375 1 4.959 1 9.375C1 13.791 4.584 17.375 9 17.375C13.416 17.375 17 13.791 17 9.375C17 4.959 13.416 1.375 9 1.375ZM9 15.775C5.464 15.775 2.6 12.911 2.6 9.375C2.6 5.839 5.464 2.975 9 2.975C12.536 2.975 15.4 5.839 15.4 9.375C15.4 12.911 12.536 15.775 9 15.775Z"
                  fill="#737C88"
                />
              </g>
              <defs>
