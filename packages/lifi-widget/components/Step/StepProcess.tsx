      ...
      >
        ...
        <Typography
          ...
          sx={{
            ...
            display: "flex",
            flexDirection: needToShowContinueButton(process) ? "column" : "row",
          }}
        >
          {title}{" "}
          {needToShowContinueButton(process) ? (
            <Button
              sx={{
                borderRadius: "6px",
                width: "120px",
        ...
        {process.txLink ? (
          <LinkButton
            ...
            sx={{
              ...
              background: "rgba(204, 214, 255, 0.20)",
              borderRadius: "4px",
            }}
          ...
          >
            ...
            >
              <path
                d="M13.25 15.8242H5C4.17157 15.8242 3.5 15.1526 3.5 14.3242V6.07422C3.5 5.24579 4.17157 4.57422 5 4.57422H8V6.07422H5V14.3242H13.25V11.3242H14.75V14.3242C14.75 15.1526 14.0784 15.8242 13.25 15.8242ZM9.275 11.1045L8.2175 10.044L12.9373 5.32422H10.25V3.82422H15.5V9.07422H14V6.38547L9.275 11.1045Z"
                fill="#F3F9F4"
              />
            </svg>
          </LinkButton>
